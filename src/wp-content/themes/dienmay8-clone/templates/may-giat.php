...
<div id="wapo-total-price-table">
	<table class="all">
		...
		<input type="button" value="-" class="minus button is-form">				<label class="screen-reader-text" for="quantity_6a4a2b0e1ca20">Front Load Washing Machine ngang LG FV1413S3WA Inverter 13kg - 2021 Quantity</label>
		<input
			type="number"
...
<div id="wapo-total-price-table">
	<table class="all">
			...
			<div class="quantity buttons_added form-normal">
		<input type="button" value="-" class="minus button is-form">				<label class="screen-reader-text" for="quantity_6a4a2b0e1015a">Front Load Washing Machine ngang LG FV1413S3WA Inverter 13kg - 2021 Quantity</label>
		<input
			type="number"

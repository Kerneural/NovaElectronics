...
<div id="yith-wapo-container" class="yith-wapo-container yith-wapo-form-style-theme" data-product-price="5970000" data-product-id="1662">
	<input type="hidden" id="yith_wapo_product_id" name="yith_wapo_product_id" value="14"><input type="hidden" id="yith_wapo_product_img" name="yith_wapo_product_img" value=""><input type="hidden" id="yith_wapo_is_single" name="yith_wapo_is_single" value="1">
